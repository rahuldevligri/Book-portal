...
CREATE TABLE `app_groups` (
  `groups_pk` bigint NOT NULL AUTO_INCREMENT,
  `group_name` varchar(100) NOT NULL,
  PRIMARY KEY (`groups_pk`),
...
INSERT INTO `app_groups` VALUES (1,'ADMIN_GROUP'),(2,'USER_GROUP');
...
-- Dump completed on 2026-03-02 12:59:37
